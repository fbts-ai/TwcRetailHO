// codeunit 50040 "payphiIntegration"
// {
...
//             TempTwcApiSetup.Get();
//             // WriteJsonFileHeader();
//             JObject.Add('aggregatorId', TempTwcApiSetup.AggregatorID);//pickupfromsetup

//             JObject.Add('callbackURL', TempTwcApiSetup."Invoice creation API URL");//pickupfromsetup
//             JObject.Add('chargeAmount', (PaymentAmount));
//             JObject.Add('currencyCode', '356');//
//             JObject.Add('desc', 'Invoice');
//             // Evaluate(merchid, tempposterminal.MerchantID);
//             JObject.Add('customerMobileNo', '');
//             JObject.Add('posAppId', TempTwcApiSetup.posAppId);
//             JObject.Add('posTillNo', POSTransaction."POS Terminal No.");
//             JObject.Add('referenceNo', POSTransaction."Receipt No.");
//             JObject.Add('storeCode', 'BIAL0002');//need to change POSTransaction."Store No."
//             JObject.WriteTo(JsonText);
//             TempBlob.CreateOutStream(OutStream);
//             OutStream.WriteText(JsonText);
//             ToFile := 'pinelab.json';
//             content.WriteFrom(JsonText);
//             Message(LowerCase(MD5Hash(Format(JObject))));
//             Message(JsonText);//needtocomment
//             content.GetHeaders(contentHeaders);
//             contentHeaders.Clear();
//             contentHeaders.Add('Content-Type', 'application/json');
//             client.DefaultRequestHeaders.Add('AggregatorID', TempTwcApiSetup.AggregatorID);
//             client.DefaultRequestHeaders.Add('MerchantID', TempTwcApiSetup.MerchantID);
//             client.DefaultRequestHeaders.Add('posAppId', TempTwcApiSetup.posAppId);
//             client.DefaultRequestHeaders.Add('storeCode', 'BIAL0002');
//             client.DefaultRequestHeaders.Add('securehash', LowerCase((MD5Hash(Format(JObject)))));
//             client.DefaultRequestHeaders.Add('AggSecretKey', TempTwcApiSetup."Agg SecretKey");
...
//             request.SetRequestUri(TempTwcApiSetup."Invoice creation API URL");
//             request.Method := 'POST';
...
//                 // WriteJsonFileHeader();
//                 Evaluate(merchid, tempposterminal.MerchantID);
//                 JObject.Add('storeCode', POSTransaction."Store No.");
//                 JObject.Add('aggregatorId', TemptwcApiSetup.AggregatorID);
//                 JObject.Add('posAppId', TemptwcApiSetup.posAppId);
//                 JObject.Add('referenceNo', POSTransaction."Receipt No.");
//                 JObject.Add('invoiceNo', POSTransaction."Receipt No.");
//                 JObject.Add('transactionType', '');
//                 JObject.WriteTo(JsonText);
//                 Message(JsonText);
...
//                 client.DefaultRequestHeaders.Add('posAppId', TempTwcApiSetup.posAppId);
//                 client.DefaultRequestHeaders.Add('storeCode', 'BIAL0002');
//                 client.DefaultRequestHeaders.Add('securehash', MD5Hash(JsonText));
//                 client.DefaultRequestHeaders.Add('AggSecretKey', TempTwcApiSetup."Agg SecretKey");

//                 request.Content := content;
//                 //https://www.plutuscloudserviceuat.in:8201/API/CloudBasedIntegration/V1/GetCloudBasedTxnStatus

//                 TemptwcApiSetup.TestField(TemptwcApiSetup."Order Status API URL");
//                 request.SetRequestUri(TemptwcApiSetup."Order Status API URL");
//                 request.Method := 'POST';
...
//                                                 IF tag = 'PaymentMode' then begin
//                a                                     txnStatusJsonObject.Get('Value', JobjToken);
//                                                     PaymentMode := JobjToken.AsValue().AsText();
//                                                 end;
//                                                 IF tag = 'Card Type' then begin
//                                                     txnStatusJsonObject.Get('Value', JobjToken);
...
//         exit(CryptographyManagement.GenerateHash(Pwd, HashAlgorithmType::SHA256));
