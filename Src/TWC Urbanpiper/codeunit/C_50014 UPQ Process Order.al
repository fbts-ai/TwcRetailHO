codeunit 50014 "UPQ Process Order"
{
    trigger OnRun()
    var
    ...
    var
        ...
        order_details_discount_id: Code[10];  //AlleRSN 171023
        order_details_discount_code: Code[50];  //AlleRSN 171023
    ...
    begin
        foreach jtoken in jorders do begin
            ...
            Evaluate(order_details_discount_id, getJsonField(jorder, 'order_details_discount_id'));  //AlleRSN 171023
            Evaluate(order_details_discount_code, getJsonField(jorder, 'order_details_discount_code'));  //AlleRSN 171023
            ...
            //ALLE_NICK_060224
            if order_details_order_state = 'customer_cancelled' then begin
                order_details_order_state := 'CANCELLED';
            end;
            ...
            if not header.FindLast() then begin
                header.Init();
                ...
                header.app_Discount_ID := order_details_discount_id; //AlleRSN 131223
                header.app_Discount_Code := order_details_discount_code; //AlleRSN 131223
                header.Insert(true);
