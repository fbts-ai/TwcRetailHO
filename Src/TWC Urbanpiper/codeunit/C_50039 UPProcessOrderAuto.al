// codeunit 50039 UPQProcessOrdersAuto
// {
//     trigger OnRun()
//     var
...
//         jsonObj.add('run_type', 'AUTOMATED');
//         //jsonObj.add('duration', Getduration);
//         jsonObj.add('duration', -1); //hardcoded as it is not in use
//         StartDateTxt := FORMAT(Today - 1, 10, '<Year4>-<Month,2>-<Day,2>');
//         jsonObj.add('startDate', StartDateTxt);
//         EndDateTxt := FORMAT(Today, 10, '<Year4>-<Month,2>-<Day,2>');
//         jsonObj.add('endDate', EndDateTxt);
