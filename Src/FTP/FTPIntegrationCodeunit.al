codeunit 50050 "FTP Integration"
{
    trigger OnRun()
    var
    ...
    begin
        // FTPIntegration(TransactionHeader);
    end;
    ...
    var
        ...
        Description: text[15];
    begin
        TransactionHeaderVAl.SetRange(Date, Today - 1);
        ...
        if TransactionHeaderVAl.FindFirst() then begin
            if store.Get(TransactionHeaderVAl."Store No.") then
                if store."FTP Integration" = true then begin
                    ...
                    TransactionHeaderFirst.SetRange(Date, Today - 1);
                    ...
                    TransactionHeader.SetFilter(Date, '%1', Today - 1);
                    ...
                    TransactionHeaderlast.SetRange(Date, Today - 1);
                    ...
                    EmailItem.Subject := store."E-mail Subject" + Format(Today - 1, 10, '<Day,2>/<Month,2>/<Year4>');
